...
public class CameraZoom : NetworkBehaviour
{
    ...
    [SerializeField, Tooltip("àÍî‘ÉYÅ[ÉÄÇµÇΩéûÇ…Ç«ÇÍÇÆÇÁÇ¢ó£Ç∑Ç©"),Networked] float minZ { get; set; }
    [SerializeField, Tooltip("ÉYÅ[ÉÄî{ó¶"), Networked] float zoomConf { get; set; }
